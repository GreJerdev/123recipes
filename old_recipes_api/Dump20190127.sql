...
CREATE TABLE `recipe_steps` (
  ...
  `recipe_step_is_deleted` tinyint(1) DEFAULT '0',
...
CREATE TABLE `recipes` (
  ...
  `recipe_stars` decimal(10,0) DEFAULT '0',
  `recipe_create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `recipe_update_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `recipe_is_deleted` bit(1) DEFAULT b'0',
  `recipe_deleted_at` timestamp NULL DEFAULT NULL,
...
--
/*!50003 DROP FUNCTION IF EXISTS `fn_uuid_from_bin` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_uuid_from_bin`(b BINARY(16)) RETURNS char(36) CHARSET utf8
    DETERMINISTIC
BEGIN
  DECLARE hex CHAR(32);
  SET hex = HEX(b);
...
/*!50003 DROP FUNCTION IF EXISTS `fn_uuid_to_bin` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_uuid_to_bin`(s CHAR(36)) RETURNS binary(16)
    DETERMINISTIC
...
-- Dump completed on 2019-01-27 22:58:40
